...
$(function() {
	...
	$("#btnSubmit").click(function() {
		...
		var param="subject="+$("#subject").val()+"&content="+$("#content").val()+"&target=ads";
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right" style="font-size: 20px">
					...
					<li><a href="#" id="btnAskT">THANKS</a></li>
					<li><a>ADS</a></li>
				</ul>
			</div>
		</div>
			...
			<table align="center" style="width: 90%;">
				...
				<tr>
					<td colspan="2" align="center">
						<a href="#" class="btn btn-lg btn-default" id="btnSubmit">제출</a>
					</td>
				</tr>
			</table>
		</div>
