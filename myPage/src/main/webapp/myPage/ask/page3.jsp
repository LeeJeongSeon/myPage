...
$(function() {
	...
	$("#btnAskR").click(function() {
		location.href=address+"report.do";
	});
	...
	$("#btnSubmit").click(function() {
		...
		var param="subject="+$("#subject").val()+"&content="+$("#content").val()+"&target=thanks";
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right" style="font-size: 20px">
					...
					<li><a href="#" id="btnAskR">REPORT</a></li>
					<li><a>THANKS</a></li>
					<li><a href="#" id="btnAskA">ADS</a></li>
				</ul>
			</div>
		</div>
	</nav>
			...
			<table align="center" style="width: 90%;">
				...
				<tr>
					<td colspan="2" align="center">
						<a href="#" class="btn btn-lg btn-success" id="btnSubmit">제출</a>
					</td>
				</tr>
			</table>
		</div>
