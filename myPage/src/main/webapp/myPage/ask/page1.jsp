...
$(function() {	
	...
	$("#btnSubmit").click(function() {
		...
		var param="subject="+$("#subject").val()+"&content="+$("#content").val()+"&target=questions";
			...
			<table align="center" style="width: 90%;">
				...
				<tr>
					<td colspan="2" align="center">
						<a href="#" class="btn btn-lg btn-primary" id="btnSubmit">제출</a>
					</td>
				</tr>
			</table>
		</div>
